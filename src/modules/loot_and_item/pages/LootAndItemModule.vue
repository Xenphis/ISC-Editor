...
<template>
  <div class="loot-item-module">
    <div class="module-header">
      <div class="module-header-icon">
        <i class="pi pi-box"></i>
      </div>
      <div>
        <h1 class="module-title">{{ t('lootAndItem.title') }}</h1>
        <p class="module-description">{{ t('lootAndItem.description') }}</p>
      </div>
    </div>
    ...
    <div class="submodule-grid">
      ...
      >
        ...
        <div class="card-content">
          <h2 class="card-title">{{ t(`lootAndItem.submodules.${mod.key}.title`) }}</h2>
          <p class="card-desc">{{ t(`lootAndItem.submodules.${mod.key}.description`) }}</p>
        </div>

        <div class="card-footer">
          <span v-if="!mod.available" class="badge-soon">
            <i class="pi pi-clock"></i>
            {{ t('lootAndItem.comingSoon') }}
          </span>
